            ...
            <main className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative z-10 -mt-32 md:-mt-36 pb-16">
                    <ContentCard className="max-w-3xl mx-auto transition-all duration-300 hover:shadow-2xl">
                        ...
                        <div className="mb-6">
                            <h3 className="text-xl font-bold text-secondary mb-4 text-left">Fokus Utama</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-secondary mb-3 text-left">Tentang Beliau</h3>
                            <p className="text-secondary/80 leading-relaxed text-left">
                                Dr. Dian Kurniati adalah seorang dosen dan peneliti di bidang Pendidikan Matematika, dengan fokus pada integrasi Education for Sustainable Development (ESD), Etnomatematika, dan pendekatan STEM dalam pembelajaran matematika. Beliau aktif mengembangkan model pembelajaran inovatif yang menggabungkan kearifan lokal dan teknologi digital melalui berbagai proyek penelitian, publikasi, serta kolaborasi nasional maupun internasional.
                            </p>
                        </div>
                    </ContentCard>
                </div>
