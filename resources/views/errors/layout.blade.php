...
<head>
    ...
    <title>@yield('title', 'Error') – ESD MathPath</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            inset: 0;
            background-image:
                linear-gradient(rgba(245,197,24,.05) 1px, transparent 1px),
        ...
        .glow-bottom {
            ...
            height: 500px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(46,68,114,.6) 0%, transparent 70%);
            pointer-events: none;
            z-index: 0;
        }
        ...
        .error-code::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, transparent 30%, rgba(245,197,24,.1) 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            filter: blur(24px);
        ...
        <a href="/" class="nav-brand">
            <div class="nav-logo">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L3 7V12C3 16.55 6.84 20.74 12 22C17.16 20.74 21 16.55 21 12V7L12 2Z" fill="#1B2A4A" stroke="#1B2A4A" stroke-width="1"/>
                    <text x="6" y="16" font-family="Arial" font-size="10" font-weight="bold" fill="#1B2A4A">M</text>
                    <path d="M8 12H16M12 8V16" stroke="#1B2A4A" stroke-width="2.5" stroke-linecap="round"/>
                </svg>
            </div>
